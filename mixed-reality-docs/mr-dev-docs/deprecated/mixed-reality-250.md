...
* 이 프로젝트를 사용 하려면 [Windows Mixed Reality를 지 원하는 권장 버전의 Unity](../develop/install-the-tools.md)가 필요 합니다.
...
**입력 리프레셔:** HoloLens에서 선택 제스처는 **공중 탭** 입니다. 모던 헤드셋에서 Xbox 컨트롤러의 **A** 단추를 사용 합니다. 자세한 내용은 [상호 작용 모델 개요](../design/interaction-fundamentals.md)를 확인 하세요.
