...
A: Windows 20H1 이상 빌드를 옵트인 ( [Insider program](https://docs.microsoft.com/windows-insider/at-home/get-started)을 통해) 하는 경우 맵 공유를 위한 새 인터페이스에 액세스할 수 있습니다. 이 새로운 기능은 Windows 장치 포털의 [Map Manager](../develop/platform-capabilities-and-apis/using-the-windows-device-portal.md#map-manager) 인터페이스를 통해 사용할 수 있습니다. 이 도구를 사용 하려면 다음 단계를 수행 합니다.
