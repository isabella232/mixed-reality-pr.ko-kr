...
응용 프로그램의 모든 잠재력을 경험할 수 있도록 응용 프로그램에 대 한 아이 추적이 중요 한 이유 (일부 향상 된 기능을 나열 하 고 있을 수 있음)에 대 한 정보를 제공 하 여 사용자가 얼마나 많은 정보를 제공 하는지 더 잘 이해할 수 있습니다.    
사용자가 시각 추적을 작동 하지 않는 이유 (위 검사를 기준으로)를 식별 하 고 잠재적인 문제를 신속 하 게 해결할 수 있는 몇 가지 제안을 제공 합니다. 
