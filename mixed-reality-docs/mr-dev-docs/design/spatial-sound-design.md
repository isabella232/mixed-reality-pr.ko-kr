...
* 잡기 작업에는 개체 주위의 손가락을 muffled 하는 것을 나타내는 짧고 약간의 tactile 사운드가 있어야 합니다. 경우에 따라 손으로 이동 하는 소리를 전달 하는 "whoosh" 사운드도 있습니다.<br/>예: [MRTK_Move_Start .wav](https://github.com/microsoft/MixedRealityToolkit-Unity/tree/mrtk_development/Assets/MRTK/SDK/StandardAssets/Audio/MRTK_Move_Start.wav)
