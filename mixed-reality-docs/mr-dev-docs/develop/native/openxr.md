...
| UWP CoreWindow API와의 상호 운용성<br />(예: 키보드/마우스) | **`MSFT` 런타임 103에서 릴리스된 확장:**<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_MSFT_holographic_window_attachment">XR_MSFT_holographic_window_attachment</a></code>
