...
[아이 추적 디자인 문서](../../design/eye-tracking.md#fallback-solutions-when-eye-tracking-is-not-available)에 설명 된 것 처럼 개발자와 개발자는 모두 응용 프로그램에 대 한 아이 추적 데이터를 사용할 수 없는 인스턴스가 있을 수 있음을 알고 있어야 합니다.
...
개발자는 아이 추적 데이터를 사용 하지 못할 수 있는 사용자를 적절 하 게 지원 해야 합니다. [Hololens 2의 시각 추적](../../design/eye-tracking.md)에서 대체 솔루션에 대 한 고려 사항에 대해 자세히 알아보세요.
