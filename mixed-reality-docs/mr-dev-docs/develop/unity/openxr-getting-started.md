...
MRTK Unity는 2.5.3 릴리스로 시작 하는 Mixed Reality OpenXR 플러그 인을 지원 합니다.  

1. [혼합 현실 기능 도구](welcome-to-mr-feature-tool.md) 를 다시 열고 Platform Support 범주의 **Mixed Reality OpenXR 플러그 인** 패키지를 선택 합니다.
