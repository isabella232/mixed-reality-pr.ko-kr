...
ms.date: 03/21/2018
ms.topic: article
keywords: Windows Mixed Reality, 디자인, 샘플 앱, 컨트롤, mrtk, 혼합 현실 Toolkit, Unity, 샘플 앱, 예제 앱, 오픈 소스, Microsoft Store, HoloLens, 혼합 현실 헤드셋, Windows Mixed Reality 헤드셋, 가상 현실 헤드셋
ms.openlocfilehash: 2856d9052f9e1d07b2f796cafeb96fb0cdef63e8
ms.sourcegitcommit: 9831b89a1641ba1b5df14419ee2a4f29d3fa2d64
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 07/29/2021
ms.locfileid: "114757312"
---
# <a name="periodic-table-of-the-elements"></a>원소의 주기율표
![요소 앱의 기간 테이블](../images/MRDL_PeriodicTable_HL1.jpg)
...
>[!NOTE]
>이 샘플 앱은 HoloLens 1 세대를 위해 설계 되었습니다. HoloLens 2 버전 [은 요소 2.0의 주기 표](periodic-table-of-the-elements-2.md) 를 참조 하세요.

[요소의 정기 테이블](https://github.com/Microsoft/MRDesignLabs_Unity_PeriodicTable) 은 Microsoft의 혼합 현실 디자인 랩에서 오픈 소스 샘플 앱입니다. **[개체 컬렉션](../../design/object-collection.md)** 을 사용 하 여 다양 한 표면 형식으로 3d 공간에서 개체의 배열을 레이아웃 하는 방법에 대해 알아봅니다. HoloLens에서 표준 입력에 응답 하는 interactable 개체를 만드는 방법에 대해서도 알아봅니다. 이 프로젝트의 구성 요소를 사용 하 여 혼합 현실 앱 환경을 만들 수 있습니다.
...
요소의 주기적 테이블은 시각화 요소와 각 속성을 3D 공간에 만듭니다. 이 도구는 응시 및 air 탭핑와 같은 HoloLens의 기본적인 상호 작용을 통합 합니다. 사용자는 애니메이션 3D 모델을 사용 하 여 요소에 대해 알아볼 수 있습니다. 이러한 사용자는 protons 및 neutrons로 구성 된 요소의 전자 핵심 이기를 시각적으로 이해할 수 있습니다.

## <a name="background"></a>배경

HoloLens 처음으로 경험 한 후에는 혼합 현실에서 정기적인 테이블 앱을 시험 하고자 했습니다. 각 요소에는 텍스트와 함께 표시 되는 데이터 요소가 많기 때문에 3D 공간에서 입력 컴퍼지션을 탐색 하는 것이 좋습니다. 사용자에 게 요소의 전자 모델을 시각화할 수 있는 기회를이 프로젝트의 또 다른 흥미로운 부분으로 제공 합니다.
...
[혼합 현실 디자인 랩에서 GitHub](https://github.com/Microsoft/MRDesignLabs_Unity_PeriodicTable)에서 Elements 앱의 주기 테이블에 대 한 스크립트 및 prefabs를 찾을 수 있습니다.

## <a name="porting-story-for-hololens-2"></a>HoloLens 2에 대 한 스토리 포팅

HoloLens 2의 instinctual 상호 작용으로 요소 앱의 주기 테이블이 업데이트 되는 방법에 대 한 스토리를 읽어 보세요.
