...
1. <span data-ttu-id="912e9-176">큐브를 다른 위치로 이동</span><span class="sxs-lookup"><span data-stu-id="912e9-176">Move the cube to a different location</span></span>
