...
1.  *프로젝트 패널* 에서 **자산** 폴더를 마우스 오른쪽 단추로 클릭 한 다음 폴더 **만들기** 를 선택  >  **Folder** 합니다. 폴더 이름을 **스크립트** 로 합니다.

    ![](images/AzureLabs-Lab311-26.png)
    ![](images/AzureLabs-Lab311-27.png)

2.  **Scripts** 폴더를 열고 해당 폴더 내에서 **Create**  >  **c # 스크립트** 만들기를 마우스 오른쪽 단추로 클릭 합니다. 스크립트 이름을 **MeetingsUI로 합니다.**
...
2.  **Scripts** 폴더 내부를 마우스 오른쪽 단추로 클릭 하 **Create** 고  >  **c # 스크립트** 만들기를 클릭 합니다. 스크립트 **그래프** 의 이름을로 합니다.
...
2.  **Scripts** 폴더 내부를 마우스 오른쪽 단추로 클릭 하 **Create** 고  >  **c # 스크립트** 만들기를 클릭 합니다. 스크립트 이름을 **GazeInput** 로 합니다.
...
2.  **Scripts** 폴더 내부를 마우스 오른쪽 단추로 클릭 하 **Create** 고  >  **c # 스크립트** 만들기를 클릭 합니다. 스크립트 **상호 작용** 의 이름을로 합니다.
