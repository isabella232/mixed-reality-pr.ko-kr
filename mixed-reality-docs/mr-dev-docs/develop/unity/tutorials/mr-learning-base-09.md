...
Unity 메뉴에서 Mixed Reality Toolkit > 유틸리티 > **MRTK용 프로젝트 구성** 을 선택하여 **MRTK Project Configurator** 창을 열고 **UWP 기능** 섹션에서 **마이크 기능 사용** 이 회색으로 표시되는지 확인합니다.
...
> [기본 상호 작용](/windows/mixed-reality/mrtk-unity/)
