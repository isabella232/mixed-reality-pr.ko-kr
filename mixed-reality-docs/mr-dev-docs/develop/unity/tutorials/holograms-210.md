...
내보내려는 앱이 2D 보기 대신 [몰입 형 보기](../../../design/app-views.md) 를 만들어야 한다고 Unity에 알려야 합니다. HoloLens를 가상 현실 장치로 추가 하 여이 작업을 수행 합니다.
...
6. **계층** 의 **커서** 개체를 **검사기** 의 맨 아래에 있는 Inputmanager의 **simplesinglepointerselector** 필드로 끕니다. **Cursor**
