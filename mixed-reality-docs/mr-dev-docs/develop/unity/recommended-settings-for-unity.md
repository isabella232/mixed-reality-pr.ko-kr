...
Unity 2019 lts +에서는 프로젝트 설정 품질 **편집** 으로 이동 하 여 프로젝트의 품질 수준을 설정 하  >  **Project Settings**  >  **Quality** 고, 아래쪽 화살표를 클릭 하 여 * * 매우 낮은 품질 수준으로 설정 하 여 **기본값** 을 설정할 수 있습니다.
