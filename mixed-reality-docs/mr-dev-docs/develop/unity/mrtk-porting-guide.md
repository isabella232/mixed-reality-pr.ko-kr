...
[Unity 2019 LTS](https://unity3d.com/unity/qa/lts-releases)로 업데이트한 후 디바이스에서 최적의 결과를 얻으려면 Unity에서 특정 설정을 업데이트하는 것이 좋습니다. 이러한 설정은 [Unity의 권장 설정](Recommended-settings-for-Unity.md)에 자세히 설명되어 있습니다.
