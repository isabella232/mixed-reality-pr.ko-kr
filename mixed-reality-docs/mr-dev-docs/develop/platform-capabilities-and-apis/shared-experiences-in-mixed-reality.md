...
ms.locfileid: "122184744"
---
# <a name="shared-experiences-in-mixed-reality"></a>혼합 현실의 공유 환경
...
* 앵커는 [Azure 공간 앵커](/azure/spatial-anchors/)를 통해 HoloLens, iOS 및 Android 장치에 공유할 수 있습니다.
...
PC 또는 TV와 같이 지원 되는 Miracast 수신기가 있는 경우 로컬 사용자에 대 한 기본 제공 Miracast 지원을 활용 하 여 추가 앱 코드가 필요 하지 않습니다.

앱에서 [MixedReality-WebRTC](https://github.com/microsoft/mixedreality-webrtc) 를 활용 합니다. 원격 사용자의 경우 또는 공유 하려는 Miracast 없는 장치가 있는 경우입니다.  WebRTC 연결을 사용 하도록 설정 하면 장치 간의 메시징에 대 한 데이터 채널을 사용 하 여 사용자 간에 1:1 오디오/비디오 스트림을 사용할 수 있습니다.  혼합 현실 구현은 HoloLens 사용자 보기의 혼합 현실 캡처 비디오 스트림을 다른 사용자에 게 제공 하 여 HoloLens를 최적화 합니다.  여러 원격 클라이언트에 대 한 비디오 스트리밍을 확장 하려는 경우 일반적으로 [SignalWire](https://signalwire.com/)와 같은 [MCU 서비스 공급자](https://webrtcglossary.com/mcu/) (Multipoint 회의 단위)가 사용 됩니다.  Azure에 대 한 한 번 클릭 SignalWire 배포는 [Freeswitch](https://github.com/andywolk/azure-freeswitch-gpu-windows)를 통해 사용할 수 있습니다.
