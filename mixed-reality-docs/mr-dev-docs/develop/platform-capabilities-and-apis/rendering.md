...
Holographic 렌더링의 핵심은 사용자에 게 실제 세계와 holograms를 함께 볼 수 있도록 하는 HoloLens와 같은 보기 표시로 렌더링 하는지 아니면 전 세계를 차단 하는 Windows Mixed Reality 몰입 형 헤드셋과 같은 불투명 한 표시를 표시 하는 것입니다.
...
항목에 대 한 하위 수준 세부 정보는 [DirectX의 렌더링](../native/rendering-in-directx.md) 문서를 참조 하세요.
