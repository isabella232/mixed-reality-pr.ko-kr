...
제스처 및 동작 컨트롤러 입력은 실제 장치와 밀접 하 게 매핑됩니다.
...
* **[블 룸](../../design/system-gesture.md#bloom)/시스템 제스처 또는 홈**: HoloLens 블 룸/시스템 제스처 또는 컨트롤러의 홈 단추를 사용 하 여 셸에 반환 하 고 시스템 작업을 수행 합니다.
...
이번에는 사용자가 시뮬레이션 API를 통해 설정할 수 있지만 에뮬레이터 사용자 인터페이스를 통해 각 연결점의 직접 제어를 개별적으로 노출 하지 않습니다. 대신 에뮬레이터에서를 전환 하는 데 사용할 수 있는 일련의 유용한 담당자가 있습니다.
...
|  지원 |  Page up/page down |  |  DPad up/down | 
...
| 왼쪽/컨트롤러 | 왼쪽 Alt 단추 길게 | 왼쪽 어깨 단추 누르기 | 왼쪽 압정 | 
| 오른쪽/컨트롤러 | 오른쪽으로 Alt 단추 길게 | 오른쪽 어깨 단추 누르기 | 오른쪽 압정 |
...
|  지원 |  본문을 위/아래로 이동 |  손 모양/컨트롤러 위로/아래로 이동 |  위쪽/아래쪽으로 설정 | (작업 없음) |
...
다음 바로 가기 키는 인식 시뮬레이션 제어판에 액세스 하 고, 시뮬레이션에 사용할 PC 입력 장치를 사용 하거나 사용 하지 않도록 설정 하는 데 사용할 수 있습니다.
