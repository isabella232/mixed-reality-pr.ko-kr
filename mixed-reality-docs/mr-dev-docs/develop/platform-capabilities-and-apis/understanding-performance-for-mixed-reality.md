...
아래 프레임 워크는 대상 프레임 속도 적중에 대 한 모범 사례를 간략하게 설명 합니다. Unity에서 개발 하는 경우 unity 환경에서 프레임 속도를 측정 하 고 개선 하는 방법에 대 한 팁은 [unity의 성능 권장 사항 문서](../unity/performance-recommendations-for-unity.md) 를 참조 하세요.
