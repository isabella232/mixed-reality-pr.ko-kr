...
"우리는 전반적으로 원래 프로젝트 추정치와 긴밀 하 게 Daniel Cheetham, 고객의 대화형 부서를 담당 하는 행복 한 마무리에서 최고 혁신 책임자를 제공 하 고 있습니다. "Ford GT40 환경은 앱이 적당 한 예산으로 몇 개월 이내에 완료할 수 HoloLens 2 있는 것이 아니라 매우 뛰어난 결과를 제공 합니다." 
