...
손 메시 표시는 성능에 큰 영향을 줄 수 있습니다. 이러한 이유로 **손 메시 시각화 사용** 옵션을 선택 취소하여 완전히 사용하지 않도록 설정할 수 있습니다.
...
이 문제에 대한 해결 방법으로 [네이티브 Mixed Reality Toolkit 리포지션](https://github.com/microsoft/MixedRealityToolkit/tree/master/DotNetNativeWorkaround)에서 DLL 원본을 제공했습니다. README의 지침에 따라 결과 이진 파일을 Unity 자산의 플러그 인 폴더에 복사하세요. 그런 다음 MRTK에 제공된 WindowsMixedRealityUtilities 스크립트가 해결 방법을 해결합니다.
