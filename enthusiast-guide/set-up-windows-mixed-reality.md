...
혼합 현실에서 Cortana 명령을 사용 하도록 설정할 수 있습니다. 그러면 음성 명령을 사용 하 여 앱을 텔레포트 하 고 열 수 있습니다. 이러한 작업에 대 한 자세한 내용은 [혼합 현실 정보](learn-mixed-reality.md) 챕터를 참조 하세요.
...
* **Windows 로고 키 + Y를 사용 하 여 수동 전환**: windows는 헤드셋을 입고 있는 시기를 검색 하기 위해 헤드셋 상태 센서를 사용 하지 않습니다. PC 데스크톱과 Windows Mixed Reality 간에 입력을 전환 하려면 Win + Y를 사용 해야 합니다.
