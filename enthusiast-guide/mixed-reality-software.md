...
#### <a name="windows-10-version-1803-april-2018-update-and-version-1809-october-2018-update"></a>Windows 10, 버전 1803 (4 월 2018 업데이트) 및 버전 1809 (10 월 2018 업데이트) ####
   ...
   | [10.0.17760.1000](https://www.microsoft.com/en-us/download/details.aspx?id=57358)  | 2018 년 10 월 1 일      | Windows 10, 버전 1809에 대 한 드라이버의 초기 공개 릴리스입니다.<br/>Windows 10, 버전 1803 및 최신 버전과 호환 됩니다.<br/><ul><li>에서 손전등 모드와 같은 새로운 Windows Mixed Reality 기능을 사용 하도록 설정 Windows 10, 버전 1809</li><li>헤드셋 추적 및 안정성 향상</li><li>동작 컨트롤러 추적 및 성능 향상</li><li>USB 성능 및 향상 된 기능</li></ul>  | 
   | [10.0.17134.1004](https://www.microsoft.com/en-us/download/details.aspx?id=56845)  | 2018년 4월 27일      | Windows 10 용 드라이버의 초기 공개 릴리스 버전 1803<br/> <ul><li>헤드셋 추적 및 안정성 향상</li><li>동작 컨트롤러 추적 및 성능 향상</li></ul>  |
