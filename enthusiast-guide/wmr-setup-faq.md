...
## <a name="during-mixed-reality-start-up-im-stuck-at-turn-your-head-side-to-side-and-then-at-the-floor"></a>혼합 현실를 시작 하는 동안 "헤드를 쪽으로 전환 하 고 바닥에서
...
## <a name="when-i-plug-in-my-headset-nothing-happensmixed-reality-portal-doesnt-open"></a>내 헤드셋에 연결 하는 경우 아무 일도 발생 하지 않음-혼합 현실 포털이 열리지 않음
...
## <a name="my-head-mount-display-doesnt-work-after-i-shut-down-and-do-a-fast-startup"></a>종료 하 고 빠른 시작을 수행한 후 헤드 탑재 디스플레이가 작동 하지 않음
